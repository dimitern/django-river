    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_updated', models.DateTimeField(auto_now=True, verbose_name='Date Updated')),
                ('order', models.IntegerField(default=0, verbose_name='Order')),
                ('action_text', models.TextField(max_length=200,
                                                 null=True, verbose_name='Action Text', blank=True)),
                ('groups', models.ManyToManyField(to='auth.Group', verbose_name='Groups')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('previous_track', mptt.fields.TreeOneToOneField(related_name='next_track',
                                                                 null=True, blank=True, to='river.ProceedingTrack', verbose_name='Previous track', on_delete=models.CASCADE)),
                ('proceeding', models.ForeignKey(related_name='tracks',
                                                 verbose_name='Proceeding', to='river.Proceeding', on_delete=models.CASCADE)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content_type', models.ForeignKey(verbose_name='Content Type',
                                                   to='contenttypes.ContentType', on_delete=models.CASCADE)),
                ('destination_state', models.ForeignKey(related_name='transitions_as_destination',
                                                        verbose_name='Next State', to='river.State', on_delete=models.CASCADE)),
                ('source_state', models.ForeignKey(related_name='transitions_as_source',
                                                   verbose_name='Source State', to='river.State', on_delete=models.CASCADE)),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='transition',
            field=models.ForeignKey(verbose_name='Transition',
                                    to='river.Transition', on_delete=models.CASCADE),
        ),
        migrations.AddField(
            model_name='proceeding',
            name='meta',
            field=models.ForeignKey(related_name='proceedings', verbose_name='Meta',
                                    to='river.ProceedingMeta', on_delete=models.CASCADE),
        ),
        migrations.AddField(
            model_name='proceeding',
            name='permissions',
        ...
        migrations.AddField(
            model_name='proceeding',
            name='transactioner',
            field=models.ForeignKey(verbose_name='Transactioner', blank=True,
